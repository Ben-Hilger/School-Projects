...
public class FourOfAKindTest{
    ...
    /**
     * Tests that points are calculated correctly when at least 4 equal numbers are correct
     */
    @Test
    public void testGetPointsToAdd(){
        dice = new int[] {2,2,2,2,4};
        FourOfAKind score = new FourOfAKind();
    ...
    /**
     * Tests that score is calculated correctly when there no 4 equal numbers present
     */
    @Test
    ...
    /**
     * Tests that isSatisfied correctly determines that at least 4 equal numbers are present
     */
    @Test
    public void testIsSatisfied(){
        dice = new int[] {2,2,2,2,5};
        FourOfAKind score = new FourOfAKind();
